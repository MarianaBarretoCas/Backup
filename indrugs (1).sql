...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2025 a las 04:02:48
...
INSERT INTO `domicilio` (`ID_DOMICILIO`, `UBICACION_DOMICILIO`, `ESTADO_DOMICILIO`, `FECHA_ENTREGA_DOMICILIO`, `ID_VEHICULO`, `ID_ORDENES`) VALUES
(1, 'Calle 10 #12-45', 'EN CAMINO', '2024-11-04 17:36:29', 1, 1),
...
INSERT INTO `medicamentos` (`ID_MEDICAMENTOS`, `NOMBRE_MEDICAMENTOS`, `DESCRIPCION_MEDICAMENTOS`) VALUES
...
CREATE TABLE `ordenes` (
  ...
  `ESTADO_ORDEN` enum('ACTIVO','INACTIVO') NOT NULL,
...
(1, '2024-11-13 11:54:57', 'SANITAS', 'ACTIVO', 5, 0, NULL, NULL),
(2, '2024-11-01 11:55:01', 'SALUD_TOTAL', 'ACTIVO', 6, 0, NULL, NULL),
(3, '2024-11-05 12:55:16', 'COMPENSAR ', 'ACTIVO', 7, 0, NULL, NULL),
(4, '2024-10-08 09:55:43', 'SURA', 'ACTIVO', 8, 0, NULL, NULL),
(5, '2024-09-10 14:55:52', 'SANITAS', 'ACTIVO', 9, 0, NULL, NULL),
(6, '2024-10-07 21:20:55', 'COMPENSAR ', 'ACTIVO', 10, 0, NULL, NULL),
(7, '2024-09-03 09:21:31', 'SANITAS', 'ACTIVO', 11, 0, NULL, NULL),
(8, '2024-07-25 07:22:02', 'SALUD_TOTAL', 'ACTIVO', 12, 0, NULL, NULL),
(9, '2024-04-02 08:22:19', 'COMPENSAR ', 'ACTIVO', 13, 0, NULL, NULL),
(10, '2023-10-03 13:23:32', 'SURA', 'ACTIVO', 14, 0, NULL, NULL);
...
CREATE TABLE `ordenes_has_medicamentos` (
  `ID_MEDICAMENTO_POR_ORDEN` int(11) NOT NULL,
  `ID_ORDENES` int(11) NOT NULL,
  `ID_MEDICAMENTOS` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `pqrs` (`ID_PQRS`, `TIPO_SOLICITUD`, `NOMBRE_COMPLETO`, `NUMERO_TELEFONO`, `TIPO_DOCUMENTO`, `NUMERO_DOCUMENTO`, `MOTIVO_PQRS`, `ID_USUARIOS`) VALUES
(1, 'Queja', 'Juan Camilo Torres Rojas ', '3228173448', 'CC', '1025142088', 'prueba', 32);
...
INSERT INTO `usuarios` (`ID_USUARIOS`, `NOMBRE_USUARIOS`, `TIPODOC_USUARIOS`, `NUMDOC_USUARIOS`, `DIRECCION_USUARIOS`, `FORMULA_USUARIO`, `ESTADO_USUARIO`, `TELEFONO_USUARIOS`, `CORREO_USUARIOS`, `CONTRASEÑA_USUARIOS`, `ID_ROLES_USUARIOS`) VALUES
...
(8, 'Valentina López', 'CC', '1093252651', 'Calle 6 #44-55', '', 'ACTIVO', '307-890-1234', 'Valentina.López@gmail.com', '1093252651vl', 2),
...
--
ALTER TABLE `domicilio`
  MODIFY `ID_DOMICILIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `medicamentos`
  MODIFY `ID_MEDICAMENTOS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `ordenes`
--
ALTER TABLE `ordenes`
  MODIFY `ID_ORDENES` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `ordenes_has_medicamentos`
--
ALTER TABLE `ordenes_has_medicamentos`
  MODIFY `ID_MEDICAMENTO_POR_ORDEN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `privilegios`
  MODIFY `ID_PRIVILEGIOS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `usuarios`
  MODIFY `ID_USUARIOS` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de la tabla `usuarios_has_privilegios`
--
ALTER TABLE `usuarios_has_privilegios`
  MODIFY `ID_PRIVILEGIO_USUARIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
